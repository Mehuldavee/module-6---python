 ...
 * pep huidlined that mens what is rule of python .
   rules like ...
...
( Identifiers: These are the names used for variables, functions, classes, etc., in Python. They follow specific rules 
(e.g., no spaces, no starting with numbers). Example:
